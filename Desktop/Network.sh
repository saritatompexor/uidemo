# Purpose-  create a basic hyperledger network phase 1.0.2
#Author -Sarita Tompe
#Description - This will create a basic network u can run this script with bash ./<filename>.sh
...
function setup(){
        ...
        cd ..
        cd conf/
         sudo cp  ../hyperledger/fabric/examples/e2e_cli/crypto-config.yaml ./
